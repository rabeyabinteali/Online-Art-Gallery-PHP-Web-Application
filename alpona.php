	...
	<div class="main-body">
			<div class="slide-container">
					...
					<?php
							...
							$attr=0;
							$sql = "SELECT img_path,Category from arts WHERE Category='alpona';";  
					...
					<div class="dotsContainer">
						<?php
							include("connection.php");
							$attr=0;
							$sql = "SELECT img_path from arts WHERE Category='alpona'";  
			...
			<div class="gallery-category-box-active" name="alpona"  onclick="location.href='alpona.php'">
